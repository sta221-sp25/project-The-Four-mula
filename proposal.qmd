...
A possible consideration for our data set in the data processing phase is to filter the data set for more recent IMDb movies to gain a better and more representative understanding of recent IMDb movie revenues.
...
Given the information provided by the data set, we are interested in investigating what factors contribute most to the movie revenue (`revenue`) of all IMDb movies to provide more insight into recent trends in the movie industry. This could help explore how producers and directors can maximize their revenue with every movie they work on. Some potential predictor variables of interest include:
